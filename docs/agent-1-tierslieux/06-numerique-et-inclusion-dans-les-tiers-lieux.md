...
### Enjeux specifiques de numerique et inclusion dans les tiers-lieux

Dans ce contexte, la question de numerique et inclusion dans les tiers-lieux emerge comme un enjeu strategique pour plusieurs raisons :
...
Avant d'entrer dans l'analyse, il convient de preciser les concepts mobilises autour de fracture numerique. Cette notion renvoie a des realites diverses qu'il convient de clarifier pour eviter les confusions.
...
Plusieurs cadres theoriques eclairent notre analyse de numerique et inclusion dans les tiers-lieux :
...
Les recherches recentes sur fracture numerique mettent en evidence plusieurs constats :
...
Numerique et inclusion dans les tiers-lieux constitue un enjeu strategique pour le mouvement des tiers-lieux. Les pistes explorees invitent a une approche pragmatique, progressive et participative.
